  ...
  return (
    <main id="main-content" className="relative bg-ink text-paper">
      ...
      <section aria-label="About Gizmoo AI" className="relative bg-ink border-b border-white/[0.08]">
        ...
        <article className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-28">
          <span className="section-label block mb-6">00 — About</span>
          <h2 className="font-display uppercase tracking-wide text-3xl md:text-5xl text-paper mb-6">
            What is Gizmoo AI?
          </h2>
          <p className="text-paper/55 text-base md:text-lg leading-relaxed font-body mb-4">
          ...
          <p className="text-paper/55 text-base md:text-lg leading-relaxed font-body mb-6">
          ...
          <dl className="grid grid-cols-2 md:grid-cols-4 gap-4 text-center">
            <div className="sarmat-card p-4">
              <dt className="font-mono text-[10px] uppercase tracking-widest text-paper/50">Calls Answered</dt>
              <dd className="font-display uppercase tracking-wide text-2xl text-paper mt-1">50,000+</dd>
            </div>
            <div className="sarmat-card p-4">
              <dt className="font-mono text-[10px] uppercase tracking-widest text-paper/50">Satisfaction</dt>
              <dd className="font-display uppercase tracking-wide text-2xl text-paper mt-1">99.7%</dd>
            </div>
            <div className="sarmat-card p-4">
              <dt className="font-mono text-[10px] uppercase tracking-widest text-paper/50">Availability</dt>
              <dd className="font-display uppercase tracking-wide text-2xl text-paper mt-1">24/7/365</dd>
            </div>
            <div className="sarmat-card p-4">
              <dt className="font-mono text-[10px] uppercase tracking-widest text-paper/50">Avg Response</dt>
              <dd className="font-display uppercase tracking-wide text-2xl text-paper mt-1">30 seconds</dd>
            </div>
          </dl>
        </article>
      </section>
      ...
      <SocialProof />
      <hr className="sarmat-hr" aria-hidden />
      <Features />
      <hr className="sarmat-hr" aria-hidden />
      <Demo />
      <hr className="sarmat-hr" aria-hidden />
