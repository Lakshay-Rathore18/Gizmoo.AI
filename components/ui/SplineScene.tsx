  ...
  return (
    <div
      className={cn(
        ...
        'bg-gradient-to-br from-white/5 via-white/5 to-white/[0.03]',
        'animate-glow-pulse',
        className,
      )}
      aria-hidden="true"
    >
      <div className="relative">
        <span className="absolute inset-0 rounded-full bg-white/20 blur-3xl animate-glow-pulse" />
        <span className="relative block w-16 h-16 border-2 border-white/30 border-t-transparent rounded-full animate-spin" />
      </div>
    </div>
  );
}
