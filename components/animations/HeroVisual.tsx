...
const orbs = [
  { cx: '20%', cy: '30%', r: 220, color: 'rgba(0,229,255,0.15)', dur: 18 },
  { cx: '70%', cy: '60%', r: 280, color: 'rgba(139,92,246,0.12)', dur: 22 },
  { cx: '50%', cy: '20%', r: 180, color: 'rgba(163,255,18,0.08)', dur: 26 },
  { cx: '80%', cy: '25%', r: 150, color: 'rgba(0,229,255,0.10)', dur: 20 },
];
  ...
  return (
    <div className={className} aria-hidden="true">
      ...
      {rings.map((r, i) => (
        <motion.div
          key={`ring-${i}`}
          className="absolute rounded-full border border-cyber-cyan/20 pointer-events-none"
          style={{
            left: r.cx,
            top: r.cy,
            width: r.r * 2,
      ...
      <div
        ...
        style={{
          background: 'radial-gradient(circle, rgba(0,229,255,0.12) 0%, rgba(139,92,246,0.06) 40%, transparent 70%)',
        }}
      />
